...
<head>
    ...
    <title>Create Account - Forklift Booking</title>
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex items-center justify-between h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    ...
                    <a href="{{ route('login') }}" class="bg-emerald-600 text-white px-6 py-2.5 rounded-lg font-semibold hover:bg-emerald-700 transition shadow-sm">
                        Login
                    </a>
                </div>
    ...
    <main class="py-16 px-4">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-10">
                ...
                <p class="text-lg text-gray-600">Sign up to book forklifts and manage your equipment rentals.</p>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 md:p-12">
                <form method="POST" action="{{ route('register') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-xs text-gray-500">Must be at least 8 characters and include: an uppercase letter, a lowercase letter and a number.</p>
                        @error('password')
                            <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
            ...
            <p class="mt-6 text-center text-sm text-gray-500">
                ...
                <a href="#" class="text-emerald-600 hover:underline">Terms and Conditions</a> 
                and 
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-400">
                        <li>📧 rajannanda123456@gmail.com.com</li>
